...
import static com.example.android.popularmovies.data.FavoritesContract.MovieEntry.TABLE_NAME;
...
public class MovieContentProvider extends ContentProvider {
    ...
    // Member variable for a FavsDbHelper that's initialized in the onCreate() method
    ...
    public boolean onCreate() {
        ...
        mFavsDbHelper = new FavsDbHelper(context);
        return true;
    }
    ...
    public Uri insert(@NonNull Uri uri, ContentValues values) {
        ...
        switch (match) {
            case MOVIES:
                ...
                if ( id > 0 ) {
                    returnUri = ContentUris.withAppendedId(FavoritesContract.MovieEntry.CONTENT_URI, id);
                } else {
